    ...
    public class Casa : Objetos.Objetos
    {
        ...
        protected override void ConfigPuntos(GraphicsDevice Graphics){
            ...
            VertexPositionColor[] puntos = new VertexPositionColor[]
            {
                ...
                new VertexPositionColor(new Vector3(15f, 0f, 0f), Color.Red),
                new VertexPositionColor(new Vector3(0f, 15f, 0f), Color.Red),
                new VertexPositionColor(new Vector3(15f, 15f, 0f), Color.Red),
                new VertexPositionColor(new Vector3(0f, 0f, 15f), Color.Red),
                new VertexPositionColor(new Vector3(15f, 0f, 15f), Color.Red),
                new VertexPositionColor(new Vector3(0f, 15f, 15f), Color.Red),
                new VertexPositionColor(new Vector3(15f, 15f, 15f), Color.Red)
            };
