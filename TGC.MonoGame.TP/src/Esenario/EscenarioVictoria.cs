...
namespace TGC.MonoGame.TP.src.Escenarios
{
    ...
    /// </summary>
    public class EscenarioVictoria : IEscenario
    {

        //----------------Variables---------------------//
        private GraphicsDevice _graphicsDevice;
        private HUD.HImagen _imagenVictoria;
        ...
        public void Initialize(GraphicsDevice device, ContentManager Content, DirectorEscenarios directorEscenarios)
        {
            ...
            this._imagenVictoria = new HImagen();
            this._imagenVictoria.Initialize(new Vector2(0.0f, 0.7f), Content, "Textures/ui/Victoria");
            this._imagenVictoria.setQuad(0.25f, device);
            ...
            this._mensajes.Add("/VICTORIA TOTAL NADIE PUDO DETENERTE");
            this._mensajes.Add("/LO SABIA ERA CUESTION DE TIEMPO");
            this._mensajes.Add("/IMPECABLE OTRO LOGRO PARA TU LISTA");
            this._mensajes.Add("/CON EL PODER DEL TANQUE TODO ES POSIBLE");
            this._mensajes.Add("/EL TANQUE ES PODER");
            this._mensajes.Add("/EL TANQUE ES FUERZA");
            this._mensajes.Add("/EL TANQUE ES VICTORIA");
            this._mensajes.Add("/EL TANQUE ES TODO LO QUE NECESITAS");
            this._mensajes.Add("/EL TANQUE ES TU MEJOR AMIGO");
            this._mensajes.Add("/EL TANQUE ES TU COMPAÑERO INSEPARABLE");
            this._mensajes.Add("/CON EL PODER DE BOCHI SE GANA TODO");
        ...
        public void Dibujar(GraphicsDevice graphicsDevice)
        {
            ...
            _imagenVictoria.Dibujado(graphicsDevice);
